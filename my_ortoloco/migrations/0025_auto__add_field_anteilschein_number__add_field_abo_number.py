...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Anteilschein.number'
        db.add_column(u'my_ortoloco_anteilschein', 'number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True),
                      keep_default=False)
        
        # Adding field 'Abo.number'
        db.add_column(u'my_ortoloco_abo', 'number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True),
                      keep_default=False)

        # Use unique IDs as a starting point (since they may match in most cases)
        if not db.dry_run:
            for abo in orm.Abo.objects.all():
                abo.number = abo.id
                abo.save()
            for anteilschein in orm.Anteilschein.objects.all():
                anteilschein.number = anteilschein.id
                anteilschein.save()

                
    def backwards(self, orm):
        # Deleting field 'Anteilschein.number'
        db.delete_column(u'my_ortoloco_anteilschein', 'number')

        # Deleting field 'Abo.number'
        db.delete_column(u'my_ortoloco_abo', 'number')
    ...
    models = {
        ...
        u'my_ortoloco.abo': {
            ...
            'groesse': ('django.db.models.fields.PositiveIntegerField', [], {'default': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'my_ortoloco.jobtyp': {
            ...
            'description': ('tinymce.models.HTMLField', [], {'default': "''", 'max_length': '1000'}),
