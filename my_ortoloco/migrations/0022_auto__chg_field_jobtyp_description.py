...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JobTyp.description'
        db.alter_column(u'my_ortoloco_jobtyp', 'description', self.gf('tinymce.models.HTMLField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'JobTyp.description'
        db.alter_column(u'my_ortoloco_jobtyp', 'description', self.gf('django.db.models.fields.TextField')(max_length=1000))
