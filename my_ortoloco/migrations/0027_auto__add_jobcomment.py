...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'my_ortoloco_jobcomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('job', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['my_ortoloco.Job'])),
            ('loco', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['my_ortoloco.Loco'])),
            ('time', self.gf('django.db.models.fields.DateTimeField')()),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'my_ortoloco', ['JobComment'])


    def backwards(self, orm):
        # Deleting model 'JobComment'
        db.delete_table(u'my_ortoloco_jobcomment')
    ...
    models = {
        ...
        u'my_ortoloco.job': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'multiplier': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
        ...
        u'my_ortoloco.jobcomment': {
            'Meta': {'object_name': 'JobComment'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['my_ortoloco.Job']"}),
            'loco': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['my_ortoloco.Loco']"}),
